...
## nondom simple
## Purpose: run an experiment with non-dominated uniform randomization
...
nondom_simple <- function(train_set,burn_in,A,theta,sd_Y,eps){
